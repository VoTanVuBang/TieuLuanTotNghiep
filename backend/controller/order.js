  ...
  catchAsyncErrors(async (req, res, next) => {
    try {
      ...
      for (const item of cart) {
        ...
        //Nếu có 2 sản phẩm thuộc 2 shop thì 2 array
        // shopItemsMap = {[shopId: "hsabdsadsahjdsbajdas232131",{item}],[...,item:]}
      }
...
router.put(
  ...
  catchAsyncErrors(async (req, res, next) => {
    try {
      ...
      if (!order) {
        return next(new ErrorHandler("Đơn hàng không hợp lệ", 400));
      }
      ...
      //Update lại cái if khi gán status
